 ...
 *              Refined Myanmar & Ethnic Gender Auto-Detector (100% Accurate Male/Female Count),
 *              Full 26-Column CSV Exporter (Formula Injection Protected) & Float .0 Stripper,
 *              🛡️ Bug #2 Fixed: Resilient escapeHtml & escapeJsAttr Callbacks
 * ==============================================================================
 */
...
/**
 * 💡 Precision Gender Auto-Detector (With Ethnic Prefix & 'မင်း' Support)
 */
  ...
  if (gStaffCategory === 'Full Time') {
    tbody.innerHTML = data.map((item, idx) => {
      ...
      <tr class="hover:bg-slate-800/40 transition">
        ...
        <td class="text-slate-300 py-3">${escapeHtml(item.gender || 'Male')}</td>
...
/**
 * 💡 FULL 26-COLUMN CSV EXPORTER (Formula Injection Protected with safeCsvCell + UTF-8 BOM)
 */
